    ...
    <div className="flex flex-col gap-8 ">
      <div className="flex flex-col gap-4">
        ...
        <p>
          ...
          conditions. Do not continue to use Gelu Horotan if you do not agree to
      ...
      <div className="flex flex-col gap-4">
        ...
        <p>
          Unless otherwise stated, Gelu Horotan and/or its licensors own the
          intellectual property rights for all material on Gelu Horotan. All
          intellectual property rights are reserved. You may access this from
          Gelu Horotan for your own personal use subjected to restrictions set
      ...
      <div className="flex flex-col gap-4">
        ...
        <ul className="list-disc list-inside flex flex-col gap-2">
          <li>Republish material from Gelu Horotan</li>
          <li>Sell, rent or sub-license material from Gelu Horotan</li>
          <li>Reproduce, duplicate or copy material from Gelu Horotan</li>
          <li>Redistribute content from Gelu Horotan</li>
        </ul>
      </div>
      <div className="flex flex-col gap-4">
        <p>
          ...
          Gelu Horotan does not filter, edit, publish or review Comments prior
          to their presence on the website.
        </p>
        <p>
          Comments do not reflect the views and opinions of Gelu Horotan,its
          agents and/or affiliates. Comments reflect the views and opinions of
          the person who post their views and opinions.
        </p>
        <p>
          {' '}
          To the extent permitted by applicable laws, Gelu Horotan shall not be
        ...
        <p>
          Gelu Horotan reserves the right to monitor all Comments and to remove
      ...
      <p>
        You hereby grant Gelu Horotan a non-exclusive license to use, reproduce,
      ...
      <div className="flex flex-col gap-4">
        ...
        <p>
          ...
          the hyperlink compensates the absence of Gelu Horotan; and (d) the
        ...
        <p>
          ...
          sending an e-mail to Gelu Horotan. Please include your name, your
        ...
        <p>
          No use of Gelu Horotan's logo or other artwork will be allowed for
